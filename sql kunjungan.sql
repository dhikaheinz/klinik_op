...
-- Dumping data for table db_klinik.pasien_kunjungan: ~4 rows (approximately)
DELETE FROM `pasien_kunjungan`;
/*!40000 ALTER TABLE `pasien_kunjungan` DISABLE KEYS */;
INSERT INTO `pasien_kunjungan` (`id_kunjungan`, `no_rm`, `tgl_kunjungan`, `waktu_kunjungan`, `nama_saksi`, `hubungan`, `updated_by`, `updated_date`) VALUES
	(1, NULL, NULL, 'Malam', 'asd', 'asd', '2', '2022-06-14 00:00:00'),
	(2, NULL, '2022-06-08', 'Malam', 'awdawd', 'awddw', '2', '2022-06-14 00:00:00'),
	(3, '1090622', '2022-06-07', 'Malam', 'asdas', 'sad', '2', '2022-06-14 00:00:00'),
	(4, '1090622', '2022-06-24', 'Malam', 'ascasd', '1212', '2', '2022-06-14 00:00:00'),
	(5, '1090622', '2022-06-15', 'Siang', '123', '123', '2', '2022-06-16 00:00:00');

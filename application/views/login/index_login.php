			...
			<div class="logo flex items-center justify-center flex-col">
				...
				<div class="px-8 py-6 text-left bg-white shadow-lg">
					...
					<form action="">
						<div class="mt-4">
							<div>
								<label class="block text-slate-600" for="email">Email<label>
							...
							<div>
								<button class="w-full py-1 mt-4 text-white bg-blue-600 rounded-md hover:bg-blue-900 shadow-md">Login</button>
							</div>
							<div class="mt-2">
								<p class="text-slate-600">Belum punya Akun? <a href="#" class="text-sm text-blue-600 hover:underline">Daftar</a></p>

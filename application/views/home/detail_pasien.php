...
<html>
  ...
  <nav
    ...
    <div id="content" class="mt-36 md:mt-0">
        ...
        <!-- Login Form -->
			<div class="dashboard flex items-center justify-center rounded-lg flex-col lg:flex-row gap-3 transition-all ">
					...
					<div class="flex md:justify-start flex-col w-full transition-all">
						...
						<div class="konten flex items-center justify-center md:items-start md:justify-start flex-col mt-5 shadow-md w-full p-3 transition-all">
                            ...
                            <div class="grid grid-cols-2 gap-4 w-full my-3">
                                ...
                                <input type="hidden" name="id_pasien" value="<?= $data_pasien->id_pasien ?>" class="w-full px-1 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600 shadow-sm">
                                ...
                                <div>Nama</div>
                                <div><input type="text" name="nama_pasien" value="<?= $data_pasien->nama_pasien ?>" class="w-full px-1 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600 shadow-sm"></div>
                                <div>No KTP</div>
                                <div><input type="text" name="nik" value="<?= $data_pasien->nik ?>" class="w-full px-1 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600 shadow-sm"></div>
                                <div>No HP</div>
                                <div><input type="text" name="no_hp" value="<?= $data_pasien->no_hp ?>" class="w-full px-1 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600 shadow-sm"></div>
                                <div>Jenis Kelamin</div>
                                <div>
									<select name="jk" id="jk" class="w-full mt-2 px-1 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600 shadow-sm">
										<option value="<?= $data_pasien->jk ?>">Jenis Kelamin</option>
										<option value="Laki Laki">Laki Laki</option>
										<option value="Perempuan">Perempuan</option>
									</select>
								</div>
                                <div>Email</div>
                                <div><input type="email" name="email" value="<?= $data_pasien->email ?>" class="w-full px-1 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600 shadow-sm"></div>
                                <div>Tempat Lahir</div>
                                <div><input type="text" name="tempat_lahir" value="<?= $data_pasien->tempat_lahir ?>" class="w-full px-1 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600 shadow-sm"></div>
                                <div>Tanggal Lahir</div>
                                <div><input type="date" name="tgl_lahir" value="<?= $data_pasien->tgl_lahir ?>" class="w-full px-1 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600 shadow-sm"></div>
                                <div>Alamat</div>
                                <div><input type="text" name="alamat" value="<?= $data_pasien->alamat ?>" class="w-full px-1 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600 shadow-sm"></div>
                                <div>Kabupaten</div>
                                <div><input type="text" name="kabupaten" value="<?= $data_pasien->kabupaten ?>" class="w-full px-1 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600 shadow-sm"></div>
                                <div>Provinsi</div>
                                <div><input type="text" name="provinsi" value="<?= $data_pasien->provinsi ?>" class="w-full px-1 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600 shadow-sm"></div>
                                <div>Kode Pos</div>
                                <div><input type="text" name="kodepos" value="<?= $data_pasien->kodepos ?>" class="w-full px-1 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600 shadow-sm"></div>
                                <div>Pekerjaan</div>
                                <div><input type="text" name="pekerjaan" value="<?= $data_pasien->pekerjaan ?>" class="w-full px-1 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600 shadow-sm"></div>
                            </div>
						</div>
					</div>
